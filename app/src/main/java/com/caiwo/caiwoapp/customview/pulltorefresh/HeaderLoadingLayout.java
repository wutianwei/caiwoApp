...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        mHeaderContainer = (LinearLayout) findViewById(R.id.vieww_refresh_header_Rel);
        mArrowImageView = (ImageView) findViewById(R.id.vieww_refresh_header_arrow_Img);
        mProgressBar = (ProgressBar) findViewById(R.id.vieww_refresh_header_Pb);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.view_refresh_header, null);
        return container;
    }
