...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    private boolean hasMoreData = true;//是否还有更多
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        mListView = listView;
        mListView.setDivider(new ColorDrawable(Color.parseColor("#dddddd")));
        mListView.setDividerHeight((int) context.getResources().getDimension(R.dimen.space_size_0_5));
    ...
    public void setHasMoreData(boolean hasMoreData) {
        ...
        if (!hasMoreData) {
            ...
            mLoadMoreFooterLayout.show(true); // false
        }
    }

    public void setViewGoen() {
        if (null != mLoadMoreFooterLayout) {
            if(mLoadMoreFooterLayout.getVisibility() == View.VISIBLE){
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        if (scrollLoadEnabled) {
            ...
            mLoadMoreFooterLayout.show(true);//上拉刷新的方法
