 ...
 * </ul>
 */
public class CircleFlowIndicator extends View implements IFlowIndicator,
        AnimationListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float circleSeparation = 4.0f * radius+radius;
        ...
        if (flowWidth != 0) {
            ...
            cx = (currentScroll * (4 * radius + radius)) / flowWidth;
        }
